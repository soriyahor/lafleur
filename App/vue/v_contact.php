<main>
<h1 class="contact">LAFLEUR - Contact</h1>
<p class="contact">Vous souhaitez obtenir des informations complémentaires, passer une commande, me parler de votre événement.</p>
<p class="contact">Contactez moi par téléphone ou passez nous rendre visite.</p>
<p class="contact">Nous serons  ravie de vous répondre.</p>
